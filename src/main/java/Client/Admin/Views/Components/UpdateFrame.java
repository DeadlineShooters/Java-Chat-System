...
public class UpdateFrame extends JFrame {
    ...
    UpdateFrame(String username, String fullName, String address, Date dob, String gender, String email, String password) {
        String[] texts = { username, fullName, address, gender, email, password };
        ...
        labels[6] = new JLabel("Date of birth: ");
